...
<section
  ...
  <div class="profile__right">
    <div class="profile__user mb-3 d-flex gap-3 align-items-center">
      ...
      <div class="profile__user-name"><?= $_SESSION["user_data"]["UserFirstName"]; ?></div>
    </div>
  ...
  <div class="profile__left mt-4 mt-md-0 w-100">
    <div class="profile__tab-content active">
      <form class="profile__form border p-3" action="App\views\auth\change_user-data.php" method="post">
        <input type="hidden" class="form__input"  name="UserId" value="<?= $_SESSION["user_data"]["UserId"]; ?>" />
        ...
        <div class="d-flex gap-3 mb-3">
          <div class="w-100">
            ...
            <input type="text" class="form__input" id="first-name" name="UserFirstName" value="<?= $_SESSION["user_data"]["UserFirstName"]; ?>" />
          </div>
          <div class="w-100">
            <label class="fw-bold mb-2" for="last-name">
              الاسم الأخير <span class="required">*</span>
            </label>
            <input type="text" class="form__input" id="last-name" name="UserLastName" value="<?= $_SESSION["user_data"]["UserLastName"]; ?>" />
          </div>
        </div>
        ...
        <div class="w-100 mb-3">
          ...
          <input type="text" class="form__input" id="email" name="UserEmail" value="<?= $_SESSION["user_data"]["UserEmail"]; ?>" />
        </div>
         <fieldset>
          ...
          <div class="w-100 mb-3">
            ...
            <input type="text" class="form__input" id="curr-password"  name="comforim_new_password"/>
          </div>
