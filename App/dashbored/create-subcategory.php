 			...
 			<div class="sidebar">
 				...
 				<nav class="mt-2">
 					<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
 						...
 						<li class="nav-item">
 							<a href="index.php?page=subcategory" class="nav-link">
 								<i class="nav-icon fas fa-file-alt"></i>
 								<p>Sub Category</p>
 							</a>
 						</li>
 						<li class="nav-item">
 							<a href="index.php?page=brands" class="nav-link">
 						...
 						<li class="nav-item">
 							<a href="index.php?page=discount" class="nav-link">
 						...
 						<li class="nav-item">
 							<a href="index.php?page=pages" class="nav-link">
